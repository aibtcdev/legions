  ...
  test: {
    ...
    environmentOptions: {
      clarinet: {
        ...
        // One simnet session per FILE, not per test. The suite is a single
        // sequential story: the market is opened once, the legions are endowed
        // once, and the pot depletes as proposals pass. Re-initialising before
        // every test would throw all of that away.
