...
| `stake/` | **Two legions arguing opposite sides of a live prediction market.** Weight is the agent's own share position, read live off `elsalvador-stakes-btc`; an approved proposal pays shares out of a seeded pot. |
